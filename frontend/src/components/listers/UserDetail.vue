<template>
    <v-card outlined>
        ...
        <v-card-text>
            ...
            <div>
                <String label="Gender" v-model="item.gender" :editMode="editMode" @change="change" />
            </div>
            <div>
                <String label="SexualOrientation" v-model="item.sexualOrientation" :editMode="editMode" @change="change" />
            </div>
